# SiMiRa - Sistem Peminjaman Barang PT CAO
...
| Software / SDK | Publisher / Maintainer | License | Description / Reference |
| :--- | :--- | :--- | :--- |
| **Flutter SDK** | Google LLC | [BSD-3-Clause](https://github.com/flutter/flutter/blob/master/LICENSE) | Cross-platform UI toolkit — [flutter.dev](https://flutter.dev) |
| **Dart SDK** | Google LLC | [BSD-3-Clause](https://github.com/dart-lang/sdk/blob/main/LICENSE) | Client-optimized programming language — [dart.dev](https://dart.dev) |
| **Android Desugar JDK Libs** | Google LLC / AOSP | [Apache-2.0](https://android.googlesource.com/platform/manifest/+/master/LICENSE) | Java 8+ API backport library for Android — [developer.android.com](https://developer.android.com) |

### Application Dependencies & Plugins

| Package Name | Version | Publisher / Author | License | Description & Reference |
| :--- | :--- | :--- | :--- | :--- |
| **[http](https://pub.dev/packages/http)** | `^1.6.0` | Dart Team (Google LLC) | [BSD-3-Clause](https://pub.dev/packages/http/license) | Composable, cross-platform HTTP request library for Dart. |
| **[shared_preferences](https://pub.dev/packages/shared_preferences)** | `^2.5.5` | Flutter Team (Google LLC) | [BSD-3-Clause](https://pub.dev/packages/shared_preferences/license) | Persistent key-value storage plugin for mobile and desktop platforms. |
...
| **flutter_test** | SDK | Google LLC | [BSD-3-Clause](https://github.com/flutter/flutter/blob/master/LICENSE) | Flutter testing framework for unit and widget tests. |
